...
export const AnimatedBorderButton = ({ children }: AnimatedBorderButtonProps) => {
  return (
    <button 
        ...
        hover:border-primary/50 transition-all duration-1000 focust:outline-none focus-visible:ring-2
        focus-visible-ring-primary focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed
        group px-8 p-y4 text-lg font-medium overflow-visible animated-border "
    >
      <svg
